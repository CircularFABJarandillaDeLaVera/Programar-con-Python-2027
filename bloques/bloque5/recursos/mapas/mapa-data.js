window.EDUSDK_MAP_DATA = {
  ...
  nodes: [
    { id: 'root', parent: null, x: 480, y: 300, type: 'central', title: 'Bloque 5', subtitle: 'Python aplicado', def: 'Datos -> procesar -> analizar -> automatizar -> resultados.', key: 'Cada libreria entra por necesidad.', err: 'Aprender cinco herramientas como cinco minicursos.' },
    ...
    { id: 'reportlab', parent: 'root', x: 900, y: 470, type: 'rama', title: 'ReportLab', subtitle: 'Conceptual', def: 'Diseno de informe PDF: resumen, tabla, alertas y conclusion.', key: 'Pensar estructura antes de sintaxis.', err: 'Detallar APIs sin respaldo.' },
    { id: 'sami', parent: 'root', x: 485, y: 610, type: 'rama', title: 'SAMI-Applied', subtitle: 'Proyecto', def: 'Precios y disponibilidad de componentes de hardware.', key: 'CSV, analisis y esquema de informe.', err: 'Forzar todas las librerias en el proyecto.' }
  ]
};
