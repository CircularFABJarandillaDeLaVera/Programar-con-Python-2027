# Trazabilidad - Bloque 5

## Fuentes

- `Programar-con-Python-2027/ingenieria/ingenieria-conocimiento-python-v4.md`
- `Programar-con-Python-2027/ingenieria/ingenieria-python-bloque5-final.md`

| Concepto | Fuente | Practica | Microevaluacion | Evidencia |
| --- | --- | --- | --- | --- |
| NumPy arrays | B5 final | Practica 01 | Array multiplicado | Precios finales y media |
| np.nan | B5 final | Practica 01 | Dato ausente | Conclusion sobre nulos |
| pd.read_csv | B5 final | Practica 02 | Completar read_csv | Carga de got_1.csv |
| loc / iloc | B5 final | Practica 03 | Etiqueta o posicion | Consultas correctas |
